...
function initBattey() {
  ...
  navigator.getBattery().then((batt) => {
    updateBattery = () => {
      ...
      if (level == 100) {
        batteryStatus.innerHTML = `Battery Full <i class="fa-solid fa-plug green-color"></i>`;
        batteryLiquid.style.height = "103%";
      } else if ((level <= 20) & !batt.charging) {
        batteryStatus.innerHTML = `Low Charge <i class="fa-solid fa-plug animated-red animated-red"></i>`;
      } else if (batt.charging) {
        batteryStatus.innerHTML = `Charging ... <i class="fa-solid fa-plug animated-green"></i>`;
      } else {
